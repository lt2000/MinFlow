...
def parse(workflow_name,shuffle_mode, num):
    data = yaml.load(
        ...
        if 'next' in function:
            ...
            if function['next']['type'] == 'switch':
                ...
                if f not in shuffle_functions:
                    ...
                    continue                 
                net = network.min_generator(num, shuffle_mode)
    ...
    return net.shuffle_n, component.workflow(workflow_name, start_functions, nodes, global_input, total, parent_cnt, foreach_functions, min_functions, bundling_functions, bundling_info, foreach_info)
